...
public class ManagerService {
	...
	public String createReservation(Manager m, Reservation r) {
		...
		if (r.getRoomID() != null) {
			...
			while (iter.hasNext()) {
				...
				Room room = new Room(room_no, room_type, room_price);
	...
	public void deleteReservation(Manager m, Customer c, String reservID) {
		...
		while (iter.hasNext()) {
			...
			if (target.getReservationID().equals(reservID)
					&& c.getCustomerID() == target.getCustomer().getCustomerID()) {
