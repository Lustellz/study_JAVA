...
<body>
	...
	<form method="post" action="joinService.jsp">
	...
	<div class="form-group">
	<input type="text" class="form-control" placeholder="Name" name="author_name" maxlength="20">
	</div>
	<div class="form-group">
	<textarea cols="50" rows="10" class="form-control" placeholder="Your Details" name="details"></textarea>
	</div>	
