function createCalendar(e, t, a) {
    function n() {
        ...
        for (var l = 0; l < s.length - 3; l++) {
            ...
            if (0 > d ? d += 12 : d > 11 && (d -= 12), 0 == l) i.className += " cld-rwd cld-nav", i.addEventListener("click", function() { "function" == typeof e.Options.ModelChange ? e.Model = e.Options.ModelChange() : e.Model = e.Options.ModelChange, createCalendar(e, t, -1) }), i.innerHTML += '<svg height="15" width="15" viewBox="0 0 100 75" fill="rgba(255,255,255,0.5)"><polyline points="0,75 100,75 50,0"></polyline></svg>';
                    ...
                    var a = l - 4;
                    i.addEventListener("click", function() { "function" == typeof e.Options.ModelChange ? e.Model = e.Options.ModelChange() : e.Model = e.Options.ModelChange, createCalendar(e, t, a) }), i.setAttribute("style", "opacity:" + (1 - Math.abs(a) / 4)), i.innerHTML += s[d].substr(0, 3)
                }(), 0 == d) {
    ...
    function l() {
        ...
        if (a.className += "cld-datetime", e.Options.NavShow && !e.Options.NavVertical) {
            ...
            n.className += " cld-rwd cld-nav", n.addEventListener("click", function() { createCalendar(e, t, -1) }), n.innerHTML = '<svg height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,50 75,0 75,100"></polyline></svg>', a.appendChild(n)
        }
        var l = document.createElement("div");
        if (l.className += " today", l.innerHTML = e.Selected.Year + ", " + s[e.Selected.Month], a.appendChild(l), e.Options.NavShow && !e.Options.NavVertical) {
            var i = document.createElement("div");
            i.className += " cld-fwd cld-nav", i.addEventListener("click", function() { createCalendar(e, t, 1) }), i.innerHTML = '<svg height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,0 75,50 0,100"></polyline></svg>', a.appendChild(i)
        }
    ...
    function i() {
        ...
        for (var t = ["일", "월", "화", "수", "목", "금", "토"], a = 0; a < t.length; a++) {
    ...
    function d() {
        function t(e) { var t = document.createElement("p"); return t.className += "cld-number", t.innerHTML += e, t }
    ...
    var s = ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
...
var Calendar = function(e, t, a) {
    this.Options = { Color: "", LinkColor: "", NavShow: !0, NavVertical: !1, NavLocation: "", DateTimeShow: !0, DateTimeFormat: "yyyy, mmm", DatetimeLocation: "", EventClick: "", EventTargetWholeDay: !1, DisabledDays: [], ModelChange: e };
